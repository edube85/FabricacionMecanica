...
public class Proyecto implements Serializable {
    ...
    /**
     * Método para calcular los días de demora
     *
     * @return
     */
    ...
    public String toString() {
        ...
        return "Proyecto [id=" + id + ", nombreTaller=" + nombreTaller + ", nombre=" + nombre + ", descripcion="
                ...
                + formatoFecha.format(fechaPed) + ", fechaRec=" + formatoFecha.format(fechaRec) + ", plazo=" + formatoFecha.format(plazo) + ", ofertaPdf=" + ofertaPdf + ", pedidoPdf="
